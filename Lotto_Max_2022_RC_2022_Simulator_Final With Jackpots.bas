...
Rem *** Lotto Max Simulator Version 2022 RC22 Working Version With Automatic Draw Date Update and Jackpots
Rem *** Fully 99.999 % working copy Most up to date.
Rem *** Written by: Russ Campbell
Rem
Rem *** Last Update : Jan 03 2022  12:01 AM
Rem
...
Locate 11, 14
Print "Release Date  : June 30 2021  -  12:01 AM          "
Locate 12, 14
Print "Registered To :                                    "
Locate 12, 30
Print reg$
...
If display$ = "Y" Then
    If speed$ = "Readable" Then speed = 37000000
...
For i = 1 To 50
    ...
    If crs$ = "Y" Then Color 10, 5
    Locate 4, 11
    Print "Lotto Max Simulator RC 2022 Version 2022   Search & Print Menu"
    If crs$ = "Y" Then Color 4, 7
    For i = 6 To 10
        Locate i, 17
        Print "["
...
Print "---------------------------------"
Print
Print "Month | Day | Year |  1st | 2nd | 3rd | 4th | 5th | 6th | 7th | Bonus | Jackput | Won |"
Print "----- | --- | ---- |  --- | --- | --- | --- | --- | --- | --- | ------|---------|-----|"
Print
pat$ = "   ## |  ## | #### |   ## |  ## |  ## |  ## |  ## |  ## |  ## | ##    |  ##     |\  \|"
For i = 1 To linecounter
    ...
    If chart(i, 13) = 0 Then chart$ = "No"
    If chart(i, 13) = 1 Then chart$ = "Yes"
    Print Using pat$; chart(i, 1); chart(i, 2); chart(i, 3); chart(i, 4); chart(i, 5); chart(i, 6); chart(i, 7); chart(i, 8); chart(i, 9); chart(i, 10); chart(i, 11); chart(i, 12); chart$
...
Print #1, Using "## ## ####  ## ## ## ## ## ## ## ## ######### #"; month12; day12; year12; entrya; entryb; entryc; entryd; entrye; entryf; entryg; entryh; jackpot; won
Return
